...
homerange %>%
  ...
  summarize(log10.mass.average=mean(log10.mass)) 
```

```
## # A tibble: 2 x 2
##   trophic.guild log10.mass.average
##   <chr>                      <dbl>
## 1 carnivore                   2.24
## 2 herbivore                   3.13
```
...
homerange %>%
  ...
  group_by(family) %>%
  summarize(carnivore.avg.mass=mean(log10.mass)) %>%
  arrange(desc(carnivore.avg.mass))
```

```
## # A tibble: 94 x 2
##    family       carnivore.avg.mass
##    <chr>                     <dbl>
##  1 ursidae                    4.99
##  2 felidae                    4.16
##  3 hyanidae                   4   
