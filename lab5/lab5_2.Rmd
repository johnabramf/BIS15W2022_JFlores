...
*There isn't 16 rows of entries in question 10 because there is some overlap between superheros and supervillains, as some of them may fit both conditions.*
```{r}
superhero_info %>%
  filter(weight>450)
```
