...
```
## # A tibble: 97 × 4
##    accelerated_healing durability super_strength hero_names  
##    <lgl>               <lgl>      <lgl>          <chr>       
##  1 TRUE                TRUE       TRUE           A-Bomb      
##  2 TRUE                TRUE       TRUE           Abe Sapien  
##  3 TRUE                TRUE       TRUE           Angel       
##  4 TRUE                TRUE       TRUE           Anti-Monitor
##  5 TRUE                TRUE       TRUE           Anti-Venom  
##  6 TRUE                TRUE       TRUE           Aquaman     
##  7 TRUE                TRUE       TRUE           Arachne     
##  8 TRUE                TRUE       TRUE           Archangel   
##  9 TRUE                TRUE       TRUE           Ardina      
## 10 TRUE                TRUE       TRUE           Ares        
## # … with 87 more rows
```
...
##   name   gender eye_color race  hair_color height publisher skin_color alignment
##   <chr>  <chr>  <chr>     <chr> <chr>       <dbl> <chr>     <chr>      <chr>    
## 1 Anti-… Male   blue      Symb… Blond         229 Marvel C… <NA>       <NA>     
## 2 Carna… Male   green     Symb… Red           185 Marvel C… <NA>       bad      
## 3 Hybrid Male   brown     Symb… Black         175 Marvel C… <NA>       good     
## 4 Spide… Male   <NA>      Symb… <NA>           NA Marvel C… <NA>       bad      
## 5 Toxin  Male   blue      Symb… Brown         188 Marvel C… <NA>       good     
## 6 Toxin  Male   black     Symb… Blond         191 Marvel C… <NA>       good     
## 7 Venom  Male   blue      Symb… Strawberr…    191 Marvel C… <NA>       bad      
## 8 Venom… Male   brown     Symb… Brown         229 Marvel C… <NA>       bad      
## 9 Venom… Male   <NA>      Symb… <NA>          226 Marvel C… <NA>       <NA>     
## # … with 1 more variable: weight <dbl>
```
...
##   <chr>      <lgl>   <lgl>               <lgl>              <lgl>               
## 1 Venom      FALSE   TRUE                FALSE              FALSE               
