...
**After running the two code chunks below, we see that there are two transects less than 3km away from a village, and transect more than 25km away from a village.
```{r}
gabon_defaunation %>%
  filter(Distance<3) %>%
  group_by(Distance) %>%
